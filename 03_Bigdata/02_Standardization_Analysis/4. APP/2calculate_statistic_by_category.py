...
with open(output_file, 'w', newline='') as output_csv_file:
    ...
    for customer_name, customer_name_value in packages.items():
        for package_catrgory, package_catrgory_value in packages[customer_name].items():
            row_of_output = []
            print(customer_name, package_catrgory, package_catrgory_value)
            row_of_output.append(customer_name)
            row_of_output.append(package_catrgory)
            row_of_output.append(package_catrgory_value)
